...
// NOTE: For the NXGallery project, I removed the 
// implementation of if2ip (line 1562), because
// libnx does not include ifaddrs.h
...
inline std::string if2ip(const std::string &ifn) {
  // NOTE: REMOVED BECAUSE LIBNX DOES NOT HAVE ifaddrs.h
  /*struct ifaddrs *ifap;
  getifaddrs(&ifap);
